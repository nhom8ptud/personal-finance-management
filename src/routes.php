...
// ), function() {
    ...
    Router::group(array(
        ...
        // taikhoan vi
        Router::get('/taikhoanvi', 'taikhoanvi@get');

        // danh muc
        Router::get('danhmuc', 'danhmuc@get');

        // thong ke
        Router::get('thongke', 'thongke@get');

        // so tiet kiem 1
        Router::get('sotietkiem1', 'sotietkiem1@get');
        Router::post('/sotietkiem1/addSotietkiem1', 'sotietkiem1@addSotietkiem1');
        Router::post('/sotietkiem1/delete', 'sotietkiem1@delete');
        Router::post('/sotietkiem1/update', 'sotietkiem1@update');
        Router::post('/sotietkiem1/update/view', 'sotietkiem1@updateview');
        Router::post('/sotietkiem1/tattoan/view', 'sotietkiem1@tattoan');
        Router::post('/sotietkiem1/tattoanluon', 'sotietkiem1@tattoanluon');
        // Settings
