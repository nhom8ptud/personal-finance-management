...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 15, 2023 at 05:51 AM
...
(10, 2, 'Bank', '14440000.00', 'Bank', 'Active', '2023-11-13 15:45:26', '2023-11-14 16:47:29');
...
(33, 2, 'LÆ°Æ¡ng ', 'Income', '0.00', '2023-11-13 15:44:49', '2023-11-13 15:44:49'),
(34, 2, 'Ä‚n sÃ¡ng', 'Expense', '5000000.00', '2023-11-13 15:45:00', '2023-11-14 15:37:29'),
(35, 2, 'Sinh hoáº¡t', 'Expense', '0.00', '2023-11-13 15:46:48', '2023-11-14 15:35:07');
...
(36, 2, 'Tiáº¿n', '500000.00', 10, 'Thiá»‡n', 34, '2023-11-13', '2023-11-13 17:05:53'),
(39, 2, 'Thá»‹t b&ograve;', '300000.00', 10, 'Tiáº¿n', 34, '2023-11-14', '2023-11-13 17:17:50'),
(40, 2, 'f&aacute;&acirc;f&aacute;', '60000.00', 10, 'Há»¯u Minh', 34, '2023-11-14', '2023-11-14 14:32:27'),
(41, 2, 'mua sua', '3000000.00', 10, 'Con anh jack', 34, '2023-11-14', '2023-11-14 14:57:58');

-- --------------------------------------------------------

--
-- Table structure for table `hanmuc`
--

CREATE TABLE `hanmuc` (
  `id` int(11) NOT NULL,
  `tenhanmuc` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `user` int(11) NOT NULL,
  `sotienhanmuc` decimal(11,2) NOT NULL,
  `account` int(11) DEFAULT '0',
  `category` int(11) DEFAULT '0',
...
--
-- Dumping data for table `hanmuc`
--

INSERT INTO `hanmuc` (`id`, `tenhanmuc`, `user`, `sotienhanmuc`, `account`, `category`, `start_date`, `end_date`) VALUES
(2, 'Äá»¥ng g&igrave; Äƒn Ä‘&oacute;', 2, '300000.00', 10, 34, '2023-11-01', '2023-11-30');
...
(7, 2, 'Jack', '5000000.00', 'Tiáº¿n', 10, '', 33, '2023-11-13', '2023-11-13 15:46:05', '2023-11-13 15:46:05'),
(8, 2, 'LÆ°Æ¡ng th&aacute;ng 13', '6000000.00', 'VNG Viá»‡t Nam', 10, '', 33, '2023-11-14', '2023-11-14 08:30:28', '2023-11-14 08:30:28'),
(9, 2, 'Th&iacute; Ä‘áº¡i', '6000000.00', 'Tiáº¿n', 10, '', 33, '2023-11-14', '2023-11-14 15:52:21', '2023-11-14 15:52:21');
...
(2, 'Huá»³nh', 'Tiáº¿n', 'followme403@gmail.com', '', '', '5644338d08dcd6adaa4b35c6e40de89cc8459f8ea6c1365576066a9636456233', 'j0K5xnO9Lsndz6jxuC7QbL5xOvgJTxAL.png', NULL, 'user', 'Active', '5000000.00', '60000000.00', '0.00', '0.00', 'en_US', 'Asia/Ho_Chi_Minh', 'VND', '2023-10-31 01:33:56');
...
--
-- Indexes for table `hanmuc`
--
ALTER TABLE `hanmuc`
  ADD PRIMARY KEY (`id`),
  ADD KEY `category_hanmuc` (`category`) USING BTREE,
...
--
-- AUTO_INCREMENT for table `hanmuc`
--
ALTER TABLE `hanmuc`
