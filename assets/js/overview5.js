...
function reports(reports) {
    ...
    if (Object.keys(reports.expenses.top).length) {
        ...
        $(".top-expenses").html("<tr><td class='text-center'>Trống!</td> </tr>");
    }

    $(".top-incomes").empty();
    if (Object.keys(reports.incomes.top).length) {
        for (let income of reports.incomes.top) {
            $(".top-incomes").append('<tr><td>'+income.title+'</td><td class="text-right">'+income.amount+'</td></tr>');
        }
    }else{
        $(".top-incomes").html("<tr><td class='text-center'>Trống!</td> </tr>");
    }

    $(".expenses").empty();
    if (Object.keys(reports.expenses).length) {
        for (let expense of reports.expenses) {
            $(".expenses").append('<tr><td>'+expense.title+'</td><td class="text-right">'+expense.amount+'</td></tr>');
        }
    }else{
        $(".expenses").html("<tr><td class='text-center'>Trống!</td> </tr>");
    }
